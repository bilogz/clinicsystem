...
-- Run manually:
-- psql "$DATABASE_URL" -f database/seeds/admin_accounts_seed.sql
...
-- scrypt hash generated using app's hash format: salt:hash
-- If you want to rotate password, update this hash for all rows.
